...
import com.tandong.sademo.view.PulldownViewActivity;
...
public class HomeActivity extends SmartActivity implements OnClickListener,
	...
	private void initView() {
		...
		aq.id(R.id.circleButton).clicked(this);
		aq.id(R.id.tv_psv).clicked(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.circleButton:
			Toast.makeText(HomeActivity.this, "我是CircleButton", 1000).show();
			break;
		case R.id.tv_psv:
			gotoActivity(PulldownViewActivity.class, false);
			break;
		default:
			break;
		}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		if (menu.contains("SmartTag")) {
			...
			gotoActivity(com.tandong.sademo.zUImageLoader.HomeActivity.class,
					false);
