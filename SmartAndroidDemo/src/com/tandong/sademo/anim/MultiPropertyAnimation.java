...
import com.tandong.sa.animation.Keyframe;
import com.tandong.sa.animation.ObjectAnimator;
import com.tandong.sa.animation.PropertyValuesHolder;
import com.tandong.sa.animation.ValueAnimator;
	...
	public class MyAnimationView extends View implements ValueAnimator.AnimatorUpdateListener {
		...
		private void createAnimation() {
			if (bounceAnim == null) {
				ShapeHolder ball;
				ball = balls.get(0);
				ObjectAnimator yBouncer = ObjectAnimator.ofFloat(ball, "y", ball.getY(), getHeight() - BALL_SIZE)
				...
				ObjectAnimator yAlphaBouncer = ObjectAnimator.ofPropertyValuesHolder(ball, pvhY, pvhAlpha).setDuration(
						DURATION / 2);
				...
				PropertyValuesHolder pvTY = PropertyValuesHolder
						.ofFloat("y", ball.getY(), ball.getY() - BALL_SIZE / 2f);
				ObjectAnimator whxyBouncer = ObjectAnimator.ofPropertyValuesHolder(ball, pvhW, pvhH, pvTX, pvTY)
				...
				ObjectAnimator yxBouncer = ObjectAnimator.ofPropertyValuesHolder(ball, pvhY, pvhX).setDuration(
						DURATION / 2);
