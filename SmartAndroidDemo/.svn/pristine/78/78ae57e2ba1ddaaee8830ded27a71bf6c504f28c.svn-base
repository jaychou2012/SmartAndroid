...
public class AnimatorEvents extends Activity {
	...
	public class MyAnimationView extends View implements Animator.AnimatorListener,
		...
		private void createAnimation() {
			if (animation == null) {
				ObjectAnimator yAnim = ObjectAnimator.ofFloat(ball, "y", ball.getY(), getHeight() - 50f).setDuration(
						1500);
				...
				ObjectAnimator xAnim = ObjectAnimator.ofFloat(ball, "x", ball.getX(), ball.getX() + 300).setDuration(
						1000);
